...
// import { QuestionQGame } from "../game/QuestionQGame";
// import { DeterminationGame } from "../game/DeterminationGame";
...
//     switch (config.mode) {
//       case "questionq":
//         let newQQ: QuestionQGame = new QuestionQGame(config.owner, this.QuestionQ);
